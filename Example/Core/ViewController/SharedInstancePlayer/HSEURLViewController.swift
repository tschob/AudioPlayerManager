...
class HSEURLViewController: UIViewController {

	let data		: [String] = ["http://a155.phobos.apple.com/us/r2000/020/Music/v4/44/b7/4c/44b74c29-2324-a848-22dc-7c7af6d205ea/mzaf_66571212866397411.plus.aac.p.m4a",
...
extension HSEURLViewController: UITableViewDelegate, UITableViewDataSource {
	...
	func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
		...
		HSAudioPlayer.sharedInstance.player.play(urlStrings: self.data, startPosition: indexPath.row)
	}
}
